    ...
    return schemePromise.then(schemes => {
        if(schemes.length == 0){
            ...
            return {
                ...
                "steps": !schemes[0].step_id?[]:schemes.map(step => (
                    {
...
async function addStep(scheme_id, {step_number,instructions}) { 
